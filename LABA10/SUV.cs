...
namespace LABA10
{
    public class SUV : Car
    {
        ...
        public SUV(string b, int y, string c, int p, int gc, bool awd, string ot) : base(b, y, c, p, gc)
        {
            AllWheelDrive = awd;
            OffRoadType = ot;
        }
        ...
        {
            return new SUV(this.Brand, this.Year, this.Color, this.Price, this.gClearance, this.AllWheelDrive, this.OffRoadType);
        }
