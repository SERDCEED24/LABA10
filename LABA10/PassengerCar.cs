...
namespace LABA10
{
    public class PassengerCar : Car
    {
        ...
        public PassengerCar(string b, int y, string c, int p, int gc, int s, int ms) : base(b, y, c, p, gc)
        {
            Seats = s;
            MaxSpeed = ms;
        }
        ...
        {
            return new PassengerCar(this.Brand, this.Year, this.Color, this.Price, this.gClearance, this.Seats, this.MaxSpeed);
        }
